        ...
        const clientesCompletos = await Promise.all(
            listaClientes.map(async (cliente) => {
                ...
                return {
                    ...
                    correoCliente: clienteMongo ? descifrarSeguro(clienteMongo.emailCliente) : '',
                    celularCliente: clienteMongo ? descifrarSeguro(clienteMongo.telefonoCliente) : '',
                    direccionCliente: clienteMongo ? descifrarSeguro(clienteMongo.direccionCliente) : '',
